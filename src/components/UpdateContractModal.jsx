    ...
    return (
        ...
        <>
            <div className='updateContractModalContainer'>
                ...
                <div className='updateContractModalContainer__btnCloseModal'>
                ...
                <div className="updateContractModalContainer__gridLabelInput">
                    ...
                    <div className="updateContractModalContainer__gridLabelInput__label">
                        <div className="updateContractModalContainer__gridLabelInput__label__prop">N° transacción</div>
                    </div>

                    <div className="updateContractModalContainer__gridLabelInput__input">
                        <input
                            name="transaction_number"
                            value={contractFormData.transaction_number}
                            onChange={handleInputChange}
                            className="updateContractModalContainer__gridLabelInput__inputFile__prop"
                        />
                    </div>
                ...
                <div className="updateContractModalContainer__gridLabelInput">
                    ...
                    <div className="updateContractModalContainer__gridLabelInput__label">
                        <div className="updateContractModalContainer__gridLabelInput__label__prop">Fecha y hora transacción</div>
                    </div>
                ...
                <div className="updateContractModalContainer__gridLabelInput">
                    ...
                    <div className="updateContractModalContainer__gridLabelInput__label">
                        <div className="updateContractModalContainer__gridLabelInput__label__prop">Nombre</div>
                    </div>
                ...
                <div className="updateContractModalContainer__gridLabelInput">
                    ...
                    <div className="updateContractModalContainer__gridLabelInput__label">
                        <div className="updateContractModalContainer__gridLabelInput__label__prop">Apellido</div>
                    </div>
                ...
                <div className="updateContractModalContainer__gridLabelInput">
                    ...
                    <div className="updateContractModalContainer__gridLabelInput__label">
                        <div className="updateContractModalContainer__gridLabelInput__label__prop">DNI</div>
                    </div>
                ...
                <div className="updateContractModalContainer__gridLabelInput">
                    ...
                    <div className="updateContractModalContainer__gridLabelInput__label">
                        <div className="updateContractModalContainer__gridLabelInput__label__prop">Teléfono</div>
                    </div>
                ...
                <div className="updateContractModalContainer__gridLabelInput">
                    ...
                    <div className="updateContractModalContainer__gridLabelInput__label">
                        <div className="updateContractModalContainer__gridLabelInput__label__prop">Archivo de contrato</div>
                    </div>
                    ...
                    <div className="updateContractModalContainer__gridLabelInput__inputFile">
                        ...
                        {contractFormData.contract_file_preview && (
                            <>
                            <p
                            className='updateContractModalContainer__gridLabelInput__inputFile__label'
                            onClick={() => {
                                const isFile = contractFormData.contract_file instanceof File;
                                const url = isFile
                ...
                <div className="updateContractModalContainer__gridLabelInput">
                    ...
                    <div className="updateContractModalContainer__gridLabelInput__label">
                        <div className="updateContractModalContainer__gridLabelInput__label__prop">Imagen DNI</div>
                    </div>
                ...
                <div className='updateContractModalContainer__btnUpdateContract'>
                    <button onClick={() => handleBtnUpdateContract(contract._id, contractFormData)} className='updateContractModalContainer__btnUpdateContract__prop'>Actualizar contrato</button>
                </div>
